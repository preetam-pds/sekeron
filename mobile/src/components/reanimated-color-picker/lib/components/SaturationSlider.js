...
export function SaturationSlider({ thumbShape, thumbSize, thumbColor, style = {}, vertical = false, reverse = false, }) {
    const { registerHandle, updateSaturation, onGestureEventFinish, solidColor, sliderThickness, activeHueStyle, thumbSize: thumbsSize, thumbShape: thumbsShape, } = useContext(CTX);
