...
export function BrightnessSlider({ thumbShape, thumbSize, thumbColor, style = {}, vertical = false, reverse = false, }) {
    const { registerHandle, updateBrightness, onGestureEventFinish, solidColor, sliderThickness, activeHueStyle, thumbSize: thumbsSize, thumbShape: thumbsShape, } = useContext(CTX);
