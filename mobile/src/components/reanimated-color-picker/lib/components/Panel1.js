...
export function Panel1({ thumbShape, thumbSize, thumbColor, style = {} }) {
    const { registerHandle, activeHueStyle, solidColor, updateSaturation, updateBrightness, onGestureEventFinish, thumbSize: thumbsSize, } = useContext(CTX);
    ...
    return (<PanGestureHandler onGestureEvent={gestureEvent} minDist={0}>
      <Animated.View onLayout={onLayout} style={[
        ...
        <ImageBackground source={require('../assets/Panel1.png')} style={[styles.panel_image, { borderRadius }]} resizeMode='stretch'/>
