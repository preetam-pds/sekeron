...
<head>
    ...
    !useContainer ? 'height:100%;' : ''
        ...
        .pell { height: 10%;} .pell-content { outline: 0; overflow-y: auto;padding: 10px;height: 100%;${contentCSSText}}
    </style>
    <style>
...
<body>
<div class="content"><div id="editor" style="height:200px; overflow:scroll;" class="pell"/></div>
<script>
